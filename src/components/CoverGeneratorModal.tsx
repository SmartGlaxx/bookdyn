  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="font-serif">Book Cover Creator</DialogTitle>
          <DialogDescription>
            Generate AI-powered cover art for "{book.title}". Costs 1 credit per generation.
          </DialogDescription>
        </DialogHeader>
          ...
          >
            {generating ? (
              <>
                ...
                Generating {count} cover{count > 1 ? "s" : ""}…
              </>
            ) : (
              <>
