  ...
  if (isMobile) {
    ...
    return (
      <div className="flex flex-col w-full overflow-x-hidden" style={{ height: "calc(100vh - 64px - 1rem)" }}>
        ...
        {/* Tab content */}
        <ScrollArea type="always" className="flex-1 min-h-0 [&>div>div]:!block [&>div>div]:!w-full">
          {mobileTab === "chapters" && (
          ...
          {mobileTab === "main" && (
            <>
              ...
              <div className={cn("px-4 py-5 mx-auto w-full max-w-full break-words overflow-x-hidden", canvasClass)} style={{ fontSize: `${canvasFontSize}px`, overflowWrap: "anywhere" }}>
