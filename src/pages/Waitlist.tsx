  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden flex items-center justify-center px-4 py-16">
      ...
      <div className="relative z-10 max-w-2xl w-full text-center flex flex-col items-center gap-8">
        ...
        {/* Heading */}
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-foreground font-['Playfair_Display']">
          Be First.{" "}
          ...
          <form onSubmit={handleSubmit} className="w-full max-w-md flex flex-col gap-3">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-6 py-3.5 rounded-full bg-primary text-primary-foreground font-medium text-sm whitespace-nowrap flex items-center gap-2 hover:opacity-90 transition-opacity disabled:opacity-60"
              >
                {status === "loading" ? (
                  "Joining..."
                ) : (
